...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~0w7dLu56Ki9oOw5LFCFk", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "237659232794", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "237659232794", // Only 1 owner Number Here, others Add to sudo numbers...
...
PACK_NAME: process.env.PACK_NAME || "𝑪𝒉𝒊𝒍𝒍𝒆𝒓 天才", // Added // Input Yours custom...
